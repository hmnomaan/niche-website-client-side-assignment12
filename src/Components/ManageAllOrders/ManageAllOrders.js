...
const ManageAllOrders = () => {
    ...
    useEffect(() => {
        fetch(`https://morning-coast-54846.herokuapp.com/orders`)
            .then(res => res.json())
    ...
    const handleCancelBookingButton = id => {
        ...
        if (processed) {
            fetch(`https://morning-coast-54846.herokuapp.com/orders/${id}`, {
                method: 'DELETE'
            })
                .then(res => res.json())
                .then(data => {
    ...
    const handleApproveButton = id => {
        fetch(`https://morning-coast-54846.herokuapp.com/orderUpdate/${id}`)
            .then(res => res.json())
            .then(data => {
