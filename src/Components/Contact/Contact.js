...
const Contact = () => {
    return (
        <div className="Contact container pt-5">
            ...
            <div className="row d-flex align-items-center"> <div className="col-md-6 col-12">
                ...
                <div className="col-md-6 col-12 px-4">
                    <div>
                        ...
                        <button className="btn btn-dark px-4 mb-5"><i className="fas fa-paper-plane me-2 "></i><a className="call-button text-white" href="mailto:hasannoman31@gmail.com">Send Message</a></button>
                    </div>
                </div>
