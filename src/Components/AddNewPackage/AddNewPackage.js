...
const AddNewPackage = () => {
    ...
    const onSubmit = data => {
        ...
        fetch('https://morning-coast-54846.herokuapp.com/package', {
            method: 'POST',
            headers: {
            ...
            <div className="d-flex justify-content-center">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" placeholder="Available/Not Available" className="form-control mb-2" {...register("availability", { required: true })} />
                        <p className="text-danger">{errors.availability?.type === 'required' && "Availability is required"}</p>
                    </div>
